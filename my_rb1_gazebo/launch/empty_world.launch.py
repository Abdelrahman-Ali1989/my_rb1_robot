...
def generate_launch_description():
    ...
    # Get Robot description package name
    robot_package_name = "my_rb1_description"

    # Set the environment variable to launch Gazebo sim through ROS2
    install_dir_path = (get_package_prefix(package_name) + "/share")
    robot_install_dir_path = (get_package_prefix(robot_package_name) + "/share")
    gazebo_resource_paths = [install_dir_path, robot_install_dir_path]
